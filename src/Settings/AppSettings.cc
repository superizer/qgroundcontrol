...
DECLARE_SETTINGSFACT(AppSettings, enableTaisync1)
DECLARE_SETTINGSFACT(AppSettings, enableTaisync2)
DECLARE_SETTINGSFACT(AppSettings, enableTaisyncVideo1)
DECLARE_SETTINGSFACT(AppSettings, enableTaisyncVideo2)
