...
Item {
    ...
    property double _ar:                QGroundControl.video2Manager.aspectRatio
    property bool   _showGrid:          QGroundControl.settingsManager.video2Settings.gridLines.rawValue > 0
    ...
    property int    _fitMode:           QGroundControl.settingsManager.video2Settings.videoFit.rawValue
    ...
    Rectangle {
        ...
        Component {
            ...
            QGCVideoBackground {
                ...
                Rectangle {
                    ...
                    width:  1
                    x:      parent.width * 0.33
                    visible: _showGrid && !QGroundControl.video2Manager.fullScreen
                }
                Rectangle {
                    color:  Qt.rgba(1,1,1,0.5)
                    height: parent.height
        ...
        Loader {
            ...
            property bool videoDisabled: QGroundControl.settingsManager.video2Settings.videoSource.rawValue === QGroundControl.settingsManager.video2Settings.disabledVideoSource
        }

        //-- Thermal Image
        Item {
            id:                 thermalItem
            width:              height * QGroundControl.video2Manager.thermalAspectRatio
            ...
            anchors.centerIn:   parent
            visible:            QGroundControl.video2Manager.hasThermal && _camera.thermalMode !== QGCCameraControl.THERMAL_OFF
            function pipOrNot() {
                if(_camera) {
